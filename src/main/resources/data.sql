...
INSERT INTO przedmioty(id,plan_studiow_id ,nazwa,link_karty )
       VALUE (1,1,'ALGEBRA Z GEOMETRIĄ ANALITYCZNĄ A','https://storage.googleapis.com/staging.conv3rt3r.appspot.com/Algebra_z_geom_analit_A.pdf'),
...
INSERT INTO kursy(id,przedmiot_id,kod,ects,czy_grupa,forma_zaliczenia)
        VALUES (1,1,'MAP003055',4,TRUE ,'EGZAMIN'),
